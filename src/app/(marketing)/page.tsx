...
const heroStats = [
    { value: "500+", label: "CA firms & teams evaluating workflows" },
...
const ecosystemMarks = [
    { name: "Zerodha", sub: "Console Exports" },
    { name: "TallyPrime", sub: "XML Import" },
    { name: "Tally ERP 9", sub: "Legacy Support" },
    { name: "CA Stack", sub: "Practice Workflows" },
    { name: "Audit Trail", sub: "Row-Level Proof" },
    { name: "Compliance", sub: "Close Controls" },
];
...
const painCards = [
    ...
    },
    {
        ...
        text: "Mismatches often surface late, right when filing pressure and client response windows are tight.",
    },
];
        ...
        <>
            <section id="hero" className="bg-[#F7F8FA] py-20 sm:py-24">
                <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
                    <div>
                        <Badge className="mb-5 border-[1.5px] border-[#93C5FD] bg-[#387ED1]/10 text-[#255FA0] hover:bg-[#387ED1]/10">
                            Built for Indian CAs & Accountants
                        </Badge>
                        <h1 className="font-sans text-[56px] font-extrabold leading-[1.04] tracking-tight text-[#1A1A2E] sm:text-[60px]">
                        ...
                        <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                            <Link
                                href="/upload"
                                className="inline-flex h-12 items-center justify-center rounded-lg bg-[#387ED1] px-7 text-sm font-semibold text-white transition-colors hover:bg-[#2f6db7]"
                            >
                                Start Free Workflow
                            </Link>
                            <Link
                                href="#how-it-works"
                                className="inline-flex h-12 items-center justify-center rounded-lg border-2 border-[#C7D7EC] bg-white px-7 text-sm font-medium text-[#1A1A2E] transition-colors hover:border-[#387ED1]/40 hover:bg-[#F7F8FA]"
                            >
                                See 3-Step Process
                            </Link>
                        </div>
                        ...
                        <div className="mt-8 flex max-w-xl items-center gap-3 rounded-2xl border border-[#D6E3F3] bg-white p-3 shadow-[0_10px_24px_rgba(15,23,42,0.06)]">
                            ...
                            />
                            <div>
                                <p className="text-sm font-semibold text-[#1A1A2E]">Built with feedback from real CA teams</p>
                                <p className="text-xs text-[#4A5568]">&ldquo;Our review effort dropped sharply once exceptions were surfaced first.&rdquo;</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="rounded-2xl border border-[#E2E8F0] bg-white p-5 shadow-[0_16px_40px_rgba(15,23,42,0.08)] sm:p-6">
                        ...
                        <div className="space-y-3 rounded-xl border border-[#E2E8F0] bg-[#F7F8FA] p-4 text-sm">
                        ...
                        <div className="mt-4 flex items-center justify-between rounded-xl border border-[#D6E3F3] bg-[#F8FBFF] px-3 py-2 text-xs font-semibold text-[#38506F]">
                            ...
                            <span className="inline-flex items-center gap-1 text-[#387ED1]"><Sparkles className="h-3.5 w-3.5" /> Export ready</span>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section id="stats" className="border-y border-[#E2E8F0] bg-white py-8">
                <div className="mx-auto grid max-w-7xl gap-4 px-4 sm:grid-cols-3 sm:px-6 lg:px-8">
                    {heroStats.map((stat) => (
                        <div key={stat.label} className="rounded-xl border border-[#E2E8F0] bg-[#F7F8FA] px-5 py-4 text-center">
                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-5 grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-6">
                        {ecosystemMarks.map((item) => (
                            <div
                                key={item.name}
                                className="rounded-xl border border-[#E2E8F0] bg-[#FAFBFC] px-3 py-3 text-center grayscale"
                            >
                                <p className="text-sm font-semibold text-[#475569]">{item.name}</p>
            ...
            <section id="problem" className="bg-[#0F172A] py-20">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-10 grid gap-5 md:grid-cols-3">
                        {painCards.map((card) => (
                            <div key={card.label} className="rounded-2xl border border-slate-700/70 bg-slate-900/60 p-6">
                                <p className="text-[52px] font-extrabold leading-none tracking-tight text-white">{card.metric}</p>
            ...
            <section id="how-it-works" className="bg-white py-20">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-10 grid gap-5 md:grid-cols-3">
                        {processSteps.map((step, idx) => (
                            <div key={step.title} className="rounded-2xl border border-[#E2E8F0] bg-[#F7F8FA] p-6 shadow-[0_10px_30px_rgba(15,23,42,0.05)]">
                                <div className="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-[#387ED1]/15 text-[#387ED1]">
                                    {idx === 0 && <FileSpreadsheet className="h-5 w-5" />}
                                    {idx === 1 && <ShieldCheck className="h-5 w-5" />}
                                    {idx === 2 && <Send className="h-5 w-5" />}
                                </div>
                                <p className="mt-4 text-[11px] font-bold tracking-[0.14em] text-[#387ED1]">STEP 0{idx + 1}</p>
                                ...
                                <div className="mt-4 space-y-2 rounded-lg border border-[#D6E3F3] bg-white p-3 text-xs text-[#42526b]">
                                    <p className="inline-flex items-center gap-1.5"><Clock3 className="h-3.5 w-3.5 text-[#387ED1]" /> Time: {step.eta}</p>
                    ...
                    <div className="mt-8 flex justify-center">
                        <Link
                            href="/upload"
                            className="inline-flex h-11 items-center justify-center rounded-lg border border-[#387ED1]/30 bg-[#387ED1]/10 px-5 text-sm font-semibold text-[#387ED1] transition-colors hover:bg-[#387ED1]/15"
                        >
            ...
            <section id="who-its-for" className="bg-[#F7F8FA] py-20">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mt-10 grid gap-5 md:grid-cols-3">
                        {personas.map((persona, idx) => (
                            <div key={persona.title} className="group rounded-2xl border border-[#E2E8F0] bg-white p-6 shadow-[0_10px_30px_rgba(15,23,42,0.05)] transition-transform hover:-translate-y-0.5">
                                ...
                                <Link href="/upload" className="mt-5 inline-flex items-center text-sm font-semibold text-[#387ED1] group-hover:text-[#2f6db7]">
            ...
            <section id="testimonials" className="bg-[#F7F8FA] py-20">
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                        ...
                        {testimonials.map((item) => (
                            <article key={item.name} className="rounded-2xl border border-[#D6E3F3] bg-white p-6 shadow-[0_10px_28px_rgba(15,23,42,0.05)]">
                                ...
                                <div className="mt-5 flex items-center gap-3">
                                    <div className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-[#EAF3FF] text-xs font-bold text-[#387ED1]">
                                        {item.avatar}
                                    </div>
                                    <div>
            ...
            <section id="final-cta" className="bg-[#387ED1] py-20 text-center text-white">
                <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
                    <h2 className="font-sans text-3xl font-semibold sm:text-4xl">Close faster with fewer exceptions and clean Tally imports.</h2>
                    <p className="mt-4 text-blue-100">Move from manual posting to exception-first review and export ready XML your team can trust each cycle.</p>
                    <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
                        <Link
                            href="/upload"
                            className="inline-flex h-12 items-center justify-center rounded-lg bg-white px-7 text-sm font-semibold text-[#387ED1] hover:bg-blue-50"
                        >
                            Get Started Free
                        </Link>
                        <Link
                            href="#pricing"
                            className="inline-flex h-12 items-center justify-center rounded-lg border-2 border-blue-100 px-7 text-sm font-medium text-white hover:bg-[#2f6db7]"
                        >
                            View Pricing
                        </Link>
                    </div>
