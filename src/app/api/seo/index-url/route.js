...
var indexing_1 = require("@/lib/seo/indexing");
function POST(request) {
    return __awaiter(this, void 0, void 0, function () {
        var authHeader, secret, requestBody, e_1, url, results, error_1;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (process.env.NODE_ENV !== 'development') {
                        if (!secret || authHeader !== "Bearer ".concat(secret)) {
                ...
                case 4:
                    url = requestBody.url;
                    if (!url) {
                        return [2 /*return*/, server_1.NextResponse.json({ error: 'Missing url in request body. Expecting { "url": "/path/to/page" }' }, { status: 400 })];
                    }
                    return [4 /*yield*/, (0, indexing_1.notifySearchEngines)(url)];
                case 5:
                    results = _a.sent();
                ...
                case 6:
                    error_1 = _a.sent();
                    console.error('Error in /api/seo/index-url:', error_1);
