 ...
 *
 * Keep the visible Tally stock master user-readable. The engine still keys
 * lots by ISIN when available, while the batch canonical-symbol map ensures
 * same-ISIN NSE/BSE trades share one display symbol before vouchers are built.
 */
